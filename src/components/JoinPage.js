      ...
      <div className="command-main command-main-full">
        <header className="command-topbar" id="top">
          <div className="command-brand">
            <span className="command-brand-tog">tog</span>
            <span className="command-brand-code">code</span>
            <span className="command-brand-ai">AI</span>
          </div>

          <div className="command-topbar-text command-pill-row">
            <span className="command-pill command-pill-email">{sessionEmail}</span>
            <span className="command-pill command-pill-session">Live Session</span>
            <span className="command-pill command-pill-engine">ENGINE:</span>
            <span className={`command-pill ${hasAuthenticatedSession ? 'is-online' : 'is-offline'}`}>
              {hasAuthenticatedSession ? 'ONLINE' : 'OFFLINE'}
            </span>
            <span className="command-pill">{pingMs > 0 ? `${pingMs}ms` : '--'}</span>
          </div>

          <button className="command-logout command-theme-toggle" onClick={toggleTheme} type="button" title={`Switch to ${theme === 'dark' ? 'light' : 'dark'} theme`}>
            {theme === 'dark' ? (
          ...
          <button className="command-logout" onClick={onLogout} type="button">
            Logout
          </button>
        </header>
